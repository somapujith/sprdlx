...
export default function Footer() {
  return (
    <footer className="w-full flex flex-col relative z-10">
      {/* Build with us */}
      <div className="w-full py-24 md:py-32 lg:py-40 flex flex-col items-center justify-center relative overflow-hidden bg-black text-white min-h-[22rem]">
        <AsciiWavesBg />
        <div
        ...
        <div className="w-full max-w-7xl mx-auto px-8 lg:px-12 relative z-10 mt-6 md:mt-8">
          <div className="border-t border-[#ccff00]/30 pt-5 flex flex-col md:flex-row md:items-start justify-between gap-6 text-sm text-[#ccff00]/70">
            <div className="flex flex-col gap-1.5">
              <a href="mailto:hello@sprdlx.co" className="hover:text-[#ccff00] transition-colors">
                hello@sprdlx.co
              </a>
              <a href="#" className="hover:text-[#ccff00] transition-colors" aria-label="Twitter (placeholder)">
                [twitter]
              </a>
              <a href="#" className="hover:text-[#ccff00] transition-colors" aria-label="LinkedIn (placeholder)">
                [linkedin]
              </a>
            </div>
